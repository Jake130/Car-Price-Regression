...
class Argument:
    ...
    6: Use leaky ReLU (standard ReLU if False)
    """
    ...
    def __init__(self, values: list):
        ...
        # valid use leaky ReLU
        values[6] = int(values[6])
        if values[6] not in [0, 1]:
            raise ValueError(f"Invalid use leaky ReLU: {values[6]}")
        ...
        self.name = "{}_{}x{}_bs{}_lr{}_sg{}_lk{}".format(
            ...
            "1" if self.use_leaky_relu else "0"
        )
...
Use leaky ReLU: {self.use_leaky_relu}
"""
...
class Model(nn.Module):
    ...
    def __init__(self, args):
        ...
        activation_fn = torch.nn.LeakyReLU(negative_slope=0.01) if args.use_leaky_relu else torch.nn.ReLU()
